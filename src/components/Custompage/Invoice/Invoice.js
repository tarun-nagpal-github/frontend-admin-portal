        ...
        <Card className="mb-30">
          <CardBody className="container-fluid">
            <Row>
              <Col sm={6}>
                ...
                <ul className="addresss-info invoice-addresss list-unstyled">
                  ...
                  <li>
                    <strong>Email: </strong> letstalk@trantorinc.com
                  </li>
                  <li>
                    <strong>Phone: </strong>{" "}
                    <a href="tel:7042791249"> +(704) 279-1249 </a>
                  </li>
                  <li>
                    <strong>Fax: </strong>+(704) 213-7895{" "}
                  </li>
                </ul>
              </Col>
              <Col sm={6} className="col-sm-3 text-left text-sm-right mb-5">
                ...
                <div>
                  <p>
                    {" "}
                    Invoice No: <a href="#">#PGS009180</a>{" "}
                  </p>{" "}
                  <br />
                  <h4>
                    <small>Invoice to:</small> Michael Bean
                  </h4>
                </div>
                <ul className="addresss-info invoice-addresss list-unstyled">
                  <li>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="text-left">
                      Mackbook Pro Retina Display Model 2017
                    </td>
                    <td>105</td>
                    <td>$30</td>
                    <td>$3500</td>
            ...
            <div className="text-right clearfix mb-3 mt-2">
              <div className="float-right mt-30">
                <h6>
                  Sub - Total amount: <strong>$5500</strong>
                </h6>
                <h6>
                  Vat: <strong>$50</strong>
                </h6>
                <h6 className="grand-invoice-amount">
                  Grand Total: <strong>$5550</strong>
                </h6>
              </div>
            </div>
          ...
          <div className="col-sm-12">
            <div className="border p-4 mb-3">
              ...
              Consequuntur id illo incidunt, iste libero quisquam? A aut cumque
              fuga fugit iusto libero officia optio quasi, quisquam saepe
