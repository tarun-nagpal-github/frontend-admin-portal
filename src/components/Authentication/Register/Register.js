...
class Register extends React.Component {
  ...
  render() {
    return (
      <section
        className="height-100vh d-flex align-items-center page-section-ptb login"
        style={{ backgroundImage: "url(assets/images/register-bg.jpg)" }}
      >
        <Container>
          <Row className="no-gutters">
            <Col
              lg={4}
              md={6}
              className="offset-lg-1 login-fancy-bg bg parallax"
              style={{
                backgroundImage: "url(assets/images/register-inner-bg.jpg)"
              }}
            >
              ...
              <div className="login-fancy pb-40 clearfix">
                ...
                <Row>
                  <div className="section-field mb-20 col-sm-6">
                    <label className="mb-10" htmlFor="fname">
                      First name*{" "}
                    </label>
                    <input
                      id="firstname"
                  ...
                  <div className="section-field mb-20 col-sm-6">
                    <label className="mb-10" htmlFor="lname">
                      Last name*{" "}
                    </label>
                    <input
                      id="lastname"
                ...
                <p className="mt-20 mb-0 remember-checkbox">
